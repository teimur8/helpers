...
class ConfirmToken extends ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\queries\ConfirmTokenQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\queries\ConfirmTokenQuery(get_called_class());
    }
}
