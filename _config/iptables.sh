...
# Внешний интерфейс
export WAN=vmbr0
export WAN_IP=10.1.30.35

# Локальная сеть
export LAN1=eth1
export LAN1_IP_RANGE=10.10.1.2/24
...
# Порты
export TCP_PORTS="21,22,25,53,143,8006"
#export UDP_PORTS="53,21,20"
...
#открываем порты до 15 портов за раз
